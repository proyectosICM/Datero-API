...
/**
 * Represents a route within the system.
 */
@NoArgsConstructor
@AllArgsConstructor
@Data
...
public class RoutesModel {
    ...
    /**
     * Indicates whether the route is currently active or inactive.
     * This is used to determine when and how to display it.
     */
    private Boolean status;

    /**
     * Date and time when this route was created.
     */
    ...
    /**
     * Date and time when this route was last updated.
     */
    ...
    /**
     * The company associated with this route.
     */
    @ManyToOne
